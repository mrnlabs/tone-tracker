...
const getTaskImages = async () => {
  taskStore.getTaskImages( singleTask.value.activation, 'activations',user.activeUserId).then(response => {
...
const onSubmit = () => {
  ...
  formData.append('entityId', singleTask.value.activation);
							...
							<div class="card-body p-4">
								<div class="row g-3">
									...
									<div class="col-md-6">
										...
										<input readonly type="text" class="form-control" id="input6" :value="singleTask?.plannedEndDate">
									</div>
